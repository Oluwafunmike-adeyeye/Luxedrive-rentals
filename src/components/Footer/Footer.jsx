      ...
      <footer className="footer">
        <Container>
          <Row>
              ...
              <div className="logo footer-logo">
                <h1>
                  <Link to='/home' className='d-flex align-items-center gap-2'>
                    ...
                    <span>
                      LUXEDRIVE Car <br /> Rental Service
                    </span>
                  </Link>
                </h1>
              </div>
            ...
            <Col lg='3' md='4' sm='6'>
                    <div className="mb-4">
                      <h5 className="footer-title mb-4">Head Office</h5>
                      <p className="office-info">Lagos, Nigeria</p>
                      <p className="office-info">Phone: +2348100000000</p>
                      <p className="office-info">Email: adeyeyeoluwafunmike1@gmail.com</p>
                      <p className="office-info">Office Time: 9am - 9pm</p>
                    </div>
            </Col>
            ...
            <Col lg="12">
                  <div className="footer-bottom">
                    ...
                    <i class="ri-copyright-line"></i> Copyright {year}, Developed by Oluwafunmike Adeyeye. All rights reserved.
                    </p>
                  </div>
            </Col>
          </Row>
