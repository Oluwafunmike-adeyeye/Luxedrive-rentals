                ...
                <Row>
                  ...
                  <Col lg="5" md="5">
                      <div className="contact-info">
                        ...
                        <p className="section-description mb-0">Lagos, Nigeria.</p>

                        <div className="d-flex align-items-center gap-2">
                          <h6 className="fs-6 mb-0">Phone:</h6>
                          <p className="section-description mb-0">+2348100000000</p>
                        </div>

                        <div className="d-flex align-items-center gap-2">
                          <h6 className="fs-6 mb-0">Email:</h6>
                          <p className="section-description">adeyeyeoluwafunmike1@gmail.com</p>
                        </div>
